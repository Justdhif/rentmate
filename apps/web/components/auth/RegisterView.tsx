...
export const RegisterView: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background dark:bg-background">
        ...
        <div className="w-full max-w-md animate-fade-in">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-muted-foreground mt-2">
              Mulai kelola bisnis kost Anda dengan cerdas dan otomatis
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <div className="relative shadow-sm rounded-xl">
                    <User className="w-4 h-4 text-gray-400 absolute left-3.5 top-3.5 z-10 pointer-events-none" />
                    <Input
                      type="text"
                      required
                      value={fullName}
      ...
      {/* Right Hero Area */}
      <AuthBanner
        title="Bergabunglah dengan Ekosistem RentMate"
        subtitle="Rasakan kemudahan operasional kost modern, mulai dari pencatatan sewa hingga automasi notifikasi tagihan."
      />
